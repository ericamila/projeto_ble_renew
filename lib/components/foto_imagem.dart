...
class FotoImagem extends StatefulWidget {
  const FotoImagem({super.key});

  @override
  State<FotoImagem> createState() => _FotoImagemState();
}

class _FotoImagemState extends State<FotoImagem> {
