...
class _DescriptorTileState extends State<DescriptorTile> {
  ...
  Future onReadPressed() async {
    try {
      await d.read();
      Snackbar.show(ABC.c, "Leitura do descritor: Sucesso", success: true);
    } catch (e) {
      Snackbar.show(ABC.c, prettyException("Erro de leitura do descritor:", e), success: false);
    }
  }
  ...
  Future onWritePressed() async {
    try {
      ...
      Snackbar.show(ABC.c, "Escrita do Descritor: Sucesso", success: true);
    } catch (e) {
      Snackbar.show(ABC.c, prettyException("Erro de gravação do descritor:", e), success: false);
    }
  }
