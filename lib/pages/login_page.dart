...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    final hasConnection = ConnectionNotifier
        .of(context)
        .value;
    final asset =
          ...
          child: Padding(
            ...
            GestureDetector(
              ...
              child: RichText(
                text: TextSpan(
                  text: 'Esqueceu a ',
                  style: TextStyle(color: Colors.grey[800], fontWeight: FontWeight.normal),
                  children: const <TextSpan>[
                    TextSpan(text: 'senha', style: TextStyle(color:verdeBotao ,fontWeight: FontWeight.bold)),
                    TextSpan(text: '?'),
                  ],
                ),
              )
